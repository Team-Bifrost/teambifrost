...
const bfrGrid = {
    ...
    convertTextLine: function (e, t = "chars", n = !1) {
        return (
            ...
            e
                .find(".word")
                .addClass("bfr-word-wrapper")
                .each(function (e) {
                    $(this).attr("style", "--word-bfr-index:" + e);
                }),
            e
                .find(".char")
                .addClass("bfr-chars-wrapper")
                .each(function (e) {
                    $(this).attr("style", "--char-bfr-index:" + e);
                }),
    ...
    cutterHtml: function (e) {
        (e = this.convertToJQuery(e)).children().each(function (e) {
            $(this)
                .addClass("bfr-html")
                .attr("style", "--html-bfr-index:" + e + ";" + ($(this).attr("style") || ""));
        }),
            (e = null);
    },
        ...
        $body.on("mousemove", function (i) {
            gsap.to(e, t.speed || 0.5, { left: i.clientX, top: i.clientY }),
                ...
                void 0 !== t &&
                    void 0 !== t.onComplete &&
                    ((n = !0),
                    bfrGrid.endAnimate(e, function (i) {
    ...
    scrollTop: function (e, t, n, i) {
        ...
        "number" == typeof e ? (o = e) : (e = this.convertToJQuery(e)).length && (o = e.get(0).offsetTop),
            gsap.to(window.Scrollbar.get(document.querySelector("#bfr-scrollbar")) || $wind, t || 1, { scrollTo: { y: o + (n || 0) }, onComplete: i }),
            (o = t = e = null);
    },
    ...
    parallaxIt: function (e, t, n, i) {
        ...
        (i = i || 0.5), (n = n || -1), TweenMax.to(t, i, { x: ((r - o.width / 2) / o.width) * n, y: ((a - o.height / 2 - s) / o.width) * n, ease: Power0.easeOut }), (o = r = a = s = i = n = null);
    },
    parallaxMoveElement: function (e, t, n, i, o) {
        ...
        let s = $('<div class="icon-circle"></div>');
        r.append(s),
            r.off("mouseleave"),
            r.off("mouseenter"),
            r.off("mousemove"),
            r
                ...
                .on("mouseenter", function (e) {
                    ...
                    o && (t.scale = "1.03"), TweenLite.to([a, s], 0.3, t), (t = null);
                })
                .on("mousemove", function (e) {
                    bfrGrid.parallaxIt(e, a, t, n), bfrGrid.parallaxIt(e, s, 2 * t, n), void 0 !== i && bfrGrid.parallaxIt(e, i, -5, 0.5);
                });
    },
                ...
                new (function (e, t, n) {
                    ...
                    function f(e = 0, t) {
                        ...
                        (this.width = o.offsetWidth),
                            ...
                            (this.imageAspect = !0 === t ? a[e].image.height / a[e].image.width : this.mat.uniforms.texture.value.image.height / this.mat.uniforms.texture.value.image.width),
                    ...
                    function g() {
                        (this.mat.uniforms.texture.value = a[u]), (this.mat.uniforms.dispFactor.value = 0), (l = !1), void 0 !== n.onEnd && n.onEnd.bind(this)();
                    }
                    $(o).addClass("three-js-loader"),
                            ...
                            .then(() => {
                                (this.loader = new THREE.TextureLoader(this.manager)),
                                    ...
                                    t.imgs.forEach((e, t) => {
                                        ...
                                        (n.magFilter = THREE.LinearFilter), (n.minFilter = THREE.LinearFilter), (n.anisotropy = this.renderer.capabilities.getMaxAnisotropy()), (a[t] = n), (n = null);
                                    });
                            })
                            .then(() => {})
                            .then(() => {
                                this.mat = new THREE.ShaderMaterial({
                                    ...
                                    uniforms: {
                                        ...
                                        texture: { type: "t", value: a[0] },
                                        texture2: { type: "t", value: a.length > 1 ? a[1] : a[0] },
                                        disp: { type: "t", value: i },
                            ...
                            .then(() => {
                                (this.animate = function () {
                                    ...
                                    (this.manager.onLoad = function () {
                                        $(o).removeClass("three-js-loader"), f.bind(s, 0)(), window.addEventListener("resize", f.bind(s, 0));
                                    });
                            })
                            .then(() => {
                                d.length &&
                        ...
                        (this.next = function () {
                            void 0 === this.renderer || l || ((this.mat.uniforms.effectFactor.value = t.intensity), (h = u), (u = (u + 1) % a.length), this.changeTo(u));
                        }),
                        (this.prev = function () {
                            void 0 === this.renderer || l || ((this.mat.uniforms.effectFactor.value = -1 * t.intensity), (h = u), (u = 0 === u ? a.length - 1 : Math.abs((u - 1) % a.length)), this.changeTo(u));
                        }),
                        (this.changeTo = function (e) {
                            (this.mat.uniforms.texture2.value = a[e]),
    ...
    loadData: function (e) {
        $(document)
            ...
            .each(function () {
                let t = $(this),
                    n = bfrGrid.getData(t, "srcset", ""),
                    i = $("<img>");
                i.attr("src", bfrGrid.getData(t, e, "")),
                    n && i.attr("srcset", n),
                    i.load(function () {
    ...
    backgroundPosition: function (e, t, n) {
        ...
        return (
            ...
            (a = this.getUndefinedVal(n.left, "-5%")),
            (s = this.getUndefinedVal(n.top, "-5%")),
            (r = this.getUndefinedVal(n.move, 100)),
            e.css({ width: i, height: o, left: a, top: s, backgroundPositionX: "calc(50% - " + -2 * r + "px)", backgroundPositionY: "calc(50% - " + -2 * r + "px)" }),
            ...
            e
                ...
                .on("mousemove", function (i) {
                    ...
                    var o = i.clientX / jQuery(this).width() - 0.5,
                        a = i.clientY / jQuery(this).height() - 0.5;
                    TweenLite.to(jQuery(this).find(e), t, { transformPerspective: 100, x: r * o + r + " ", y: r * a + r + "" }), void 0 !== n.onEnter && n.onEnter(jQuery(this), i);
                })
    ...
    scaleIt: function (e, t, n) {
        ...
        var i, o, r, a;
        (a = body.hasClass("bfr-effect-scroll") ? window.$wind.scrollTop : window.$wind.scrollTop()), (r = this.getUndefinedVal(n.plus, 0)), (i = this.getUndefinedVal(n.position, !1));
        var s = t.offset();
        return (o = void 0 === s || body.hasClass("bfr-effect-scroll") ? 0 : s.top), i && (o -= a), a / (t.height() + o + r);
    },
    scrollerIt: function (e, t, n) {
        ...
        var i,
            o,
            r,
            a = window.$wind.scrollTop();
        (r = this.getUndefinedVal(n.duration, 0)), (o = this.getUndefinedVal(n.plus, 0));
        var s = t.offset();
        (i = void 0 !== s ? s.top : 0), (i += r);
        var l = t.height() + i + o;
        if (i <= a && void 0 !== n.action) {
            var d = i - a,
                c = d / l,
                h = a / (t.height() + i + o);
            n.action({ scroll: d, position: c, targetEnd: l, ScrollTop: a, num: h });
        }
        return h;
    },
    setPositionMoveSection: function (e, t, n) {
        if (void 0 !== e) {
            var i = e.offset(),
                o = void 0 === i ? 0 : i.top;
            (t = bfrGrid.getUndefinedVal(t, 2)), (n = bfrGrid.getUndefinedVal(n, 0));
    ...
    convertTextWord: function (e, t, n) {
        ...
        for (var r = 0; r < i.length; r++)
            if (i[r].length > 0) {
                if (((o += '<span class="bfr-wrapper">'), n)) {
                    o += '<span class="bfr-word-wrapper">';
                    for (var a = 0; a < i[r].length; a++) o += '<span class="bfr-chars-wrapper">' + i[r].charAt(a) + "</span>";
                    o += "</span>";
                } else o += '<span class="bfr-word-wrapper">' + i[r] + "</span>";
                o += "</span>";
            }
        t.append(o);
    },
    ...
    parallaxMoveElemntCir: function (e, t, n, i, o) {
        ...
        var s = r.html(),
            ...
            d = $('<div class="bfr-grid-parallax">' + s + "</div>");
        r.html(""),
            r.append(l),
            r.append(d),
            r
                .on("mouseleave", function (e) {
                    TweenMax.to(r, n, { scale: 1 }), TweenMax.to(d, 0.3, { scale: 1, x: 0, y: 0 }), TweenMax.to(l, n, { scale: 1, x: 0, y: 0 });
                })
                .on("mouseenter", function (e) {
                    TweenMax.to(r, n, { transformOrigin: "0 0", scale: 1 }), TweenMax.to(l, n, { scale: 1.2 });
                })
                .on("mousemove", function (e) {
                    a.parallaxIt(e, d, t), bfrGrid.parallaxIt(e, l, t);
                });
    },
    ...
    animateText: function (e, t, n, i) {
        (t = this.convertToJQuery(t)).each(function () {
            let e = $(this);
            bfrGrid.convertTextWord(e, e), void 0 !== n && e.attr(n, "animate"), void 0 !== i && e.removeClass(i), e.addClass("bfr-has-animate-text");
        });
        var o = 0;
        function r() {
            t.each(function () {
                let e = $(this);
                if (e.hasClass("bfr-animate")) return;
                let t = e.offset().top;
                void 0 !== t && o > t - (window.$wind.height() - 100) && (e.hasClass("bfr-animate") || e.addClass("bfr-animate"));
            });
        }
        var a = null;
        _window.$wind.getListener(function (e) {
            (o = void 0 === e.offset ? window.$wind.scrollTop() : 0), a && clearTimeout(a), (a = setTimeout(r, 10));
        });
    },
    ...
    progressCircle: function (e) {
        const t = $('[data-bfr-grid="progress-circle"]'),
            n = this.removeAttr(t, "data-bfr-grid-stroke");
        var i = void 0 === n ? "" : 'stroke="' + n + '"';
        t.css({ position: "fixed", right: "-60px", bottom: "60px", width: "52px", height: "52px", "z-index": "99999999" }),
            t.append(
                '<svg class="bfr-progress-circle-up" width="100%" height="100%" ' +
                    i +
                    ' viewBox="0 0 100 100" preserveAspectRatio="xMinYMin meet" fill="none">\n        <path class="bfr-progress-path" d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" style="transition:  stroke-dashoffset 300ms linear 0s;stroke-dasharray: 307.919, 307.919; stroke-dashoffset: 309;"></path>    </svg>'
            );
        var o = wind;
        e.isScroller(!0) && (o = e.getScrollbar()),
            e.getListener(function (e) {
                ...
                void 0 === e.offset ? (n = window.$wind.scrollTop()) : ((n = e.offset.y), (i = $(document).height() - o.getSize().content.height + 100)),
                    n > 70
                        ? (TweenMax.to(t, 1, { ease: Back.easeOut.config(4), right: 60 }), t.find(".bfr-progress-path").css("stroke-dashoffset", 300 - Math.round((300 * n) / i) + "%"))
...
jQuery.fn.bfrGridStyleObject = function () {
